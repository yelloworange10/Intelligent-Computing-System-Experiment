...
class FullyConnectedLayer(object):
    ...
    def forward(self, input): # 前向传播计算
        ...
        self.output = np.matmul(input, self.weight) + self.bias # 可以换成dot试试
    ...
    def update_param(self, lr):  # 参数更新
        ...
        self.bias -= lr * np.sum(self.d_bias, axis=1)
...
class ReLULayer(object):
    ...
    def backward(self, top_diff):   # 反向传播的计算
        ...
        bottom_diff = (self.input > 0) * top_diff   # 对于输入小于或等于0的单元，梯度被设置为0
